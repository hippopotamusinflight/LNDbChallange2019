...
# ## 2020_02_08_2005-extract_all_cubes-v1.04
...
no output
'''
def extract_background(mhd_path,                       fakecube_annotation_path,                       realcube_annotation_path,\          
                       cube_size,                       num_to_extract):           # takes one img object
...
extract_background(mhd_path,fakecube_annotation_path,realcube_annotation_path,plot_output_path,6,2)
extract_background(mhd_path,fakecube_annotation_path,realcube_annotation_path,plot_output_path,10,2)
extract_background(mhd_path,fakecube_annotation_path,realcube_annotation_path,plot_output_path,20,2)
